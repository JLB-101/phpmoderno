...
<body>
    ...
    <section class="section">
        ...
        <div class="container">
            ...
            <h1> Adding numbers | somando numeros (v1.0)</h1>
            <?php
    ...
    <section class="section">
        ...
        <div class="container">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="GET">
                ...
                <div>
                    <label for="sobrenome">Primeiro numero </label>
                    <input type="number" name="x"  value="<?php $x; ?>" requered>
                </div>
                <div>
                    <label for="sobrenome"> Segundo Numero </label>
    ...
    <section class="section">
        ...
        <div class="container">
        <h1> Result | Resultado da Soma</h1>
            <?php
